...
public class Buttons_Builder  {
   ...
   {
	   Button dec=new Button("1/x");
		
		dec.setFont(Font.font(15));
		dec.setStyle("-fx-background-color: rgb(184,184,184)");
		return dec;
   }
   
   public Button min()
   {
	   Button mins=new Button("+-");
		
		mins.setFont(Font.font(15));
		mins.setStyle("-fx-background-color: rgb(184,184,184)");
		return mins; 
   }
